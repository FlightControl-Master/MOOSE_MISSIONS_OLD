...
for Heading = 0, 360,60 do
  ...
  local x = ZonePointVec2:GetLat() + math.cos( Radial ) * 300
  local y = ZonePointVec2:GetLon() + math.sin( Radial ) * 300
  SpawnBarrack:SpawnFromPointVec2( POINT_VEC2:New( x, y ), Heading )
end
