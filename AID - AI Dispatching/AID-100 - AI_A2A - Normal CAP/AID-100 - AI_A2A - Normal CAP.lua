...
A2ADispatcher:InitEngageRadius( 300000 )
...
A2ADispatcher:SetSquadronTakeoffInAir( "Mineralnye" )
A2ADispatcher:SetSquadronTakeoffInAir( "Sochi" )
A2ADispatcher:SetSquadronTakeoffInAir( "Mozdok" )
A2ADispatcher:SetSquadronTakeoffInAir( "Maykop" )
A2ADispatcher:SetSquadronTakeoffInAir( "Novo" )

-- Setup the Landing methods
A2ADispatcher:SetSquadronLandingAtRunway( "Mineralnye" )
A2ADispatcher:SetSquadronLandingAtRunway( "Sochi" )
A2ADispatcher:SetSquadronLandingAtRunway( "Mozdok" )
A2ADispatcher:SetSquadronLandingAtRunway( "Maykop" )
A2ADispatcher:SetSquadronLandingAtRunway( "Novo" )
