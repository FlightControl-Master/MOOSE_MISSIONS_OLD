...
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Beatty_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Boulder_City_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Creech_AFB, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Echo_Bay, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Groom_Lake_AFB, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Henderson_Executive_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Jean_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Laughlin_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Lincoln_County, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.McCarran_International_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Mellan_Airstrip, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Mesquite, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Mina_Airport_3Q0, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Nellis_AFB, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.North_Las_Vegas, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Pahute_Mesa_Airstrip, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Tonopah_Airport, { "Group Template Name" }, 20 )
A2ADispatcher:SetSquadron( "Squadron Name", AIRBASE.Nevada.Tonopah_Test_Range_Airfield, { "Group Template Name" }, 20 )
